...
describe("StatusBar", () => {
  ...
  it("puts the full root/path string in the title tooltip", () => {
    render(<StatusBar root={ROOT} path="deeply/nested/folder/note.md" />);
